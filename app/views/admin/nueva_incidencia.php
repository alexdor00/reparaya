...
$stmt = $db->prepare("SELECT * FROM usuarios WHERE rol = 'cliente'");
$stmt->execute();
...
<head>
    ...
    <title>ReparaYa - Nueva Incidencia Admin</title>
    ...
    <div class="row justify-content-center">
        <div class="col-md-7">
            <div class="card shadow p-4">
                <h4 class="mb-4">Nueva Incidencia</h4>
                ...
                <form action="../../../app/controllers/AdminController.php" method="POST">
                    ...
                    <button type="submit" class="btn btn-danger w-100">Crear Incidencia</button>
                </form>
            </div>
        </div>
    </div>
