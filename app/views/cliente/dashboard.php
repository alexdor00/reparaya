...
<div class="container mt-4">
    ...
    <p>Bienvenido a tu panel. Aqui podras gestionar tus avisos.</p>
    ...
    <div class="row mt-4">
        <div class="col-md-4">
            <div class="card text-center p-3">
                ...
                <a href="mis_avisos.php" class="btn btn-warning">Ver Avisos</a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card text-center p-3">
                <h5>Nueva Solicitud</h5>
                <p>Pedir un tecnico</p>
                <a href="nueva_incidencia.php" class="btn btn-warning">Nueva Solicitud</a>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card text-center p-3">
                ...
                <a href="../../app/views/perfil.php" class="btn btn-warning">Ver Perfil</a>
            </div>
        </div>
    </div>
</div>
